...
export const metadata: Metadata = {
  title: "Hair Root Wellness Box | Inruuts Design 2",
  description: "Explore the five-part Inruuts Hair Root Wellness Box and see how a personalized system is explained before purchase.",
};

export default function DesignTwoPlan() {
  return <main className="d2w-page d2w-plan">
    <D2Hero eyebrow="The Inruuts Hair Root Wellness Box" title="A system, not just products." copy="One personalized box brings the internal foundation, scalp environment, growth-cycle review, root-focused ritual and simple guidance into one explainable routine." image="/assets/root-wellness-box.jpg" alt="Illustrative open Hair Root Wellness Box with five coordinated ritual components" note="Illustrative framework · Final contents shown before purchase" cta="Build my personalized box" />
    ...
    <section className="d2-plan-transparency">
      ...
      <div className="d2-plan-transparency-list">
        <article><b>01</b><h3>Exact contents</h3><p>Product names, ingredients or Supplement Facts, quantities and manufacturers are shown before checkout.</p></article>
        <article><b>02</b><h3>Use + cautions</h3><p>Daily and weekly instructions sit beside allergies, contraindications and reasons to stop.</p></article>
        <article><b>03</b><h3>Price + delivery</h3><p>USD price, recurring terms if any, U.S. delivery timing, returns and support appear before payment.</p></article>
        <article><b>04</b><h3>Review point</h3><p>The plan explains when to check routine fit and when an outside licensed medical professional may be more appropriate.</p></article>
      </div>
    </section>
    ...
    <D2FinalCampaign image="/assets/root-wellness-box.jpg" alt="Illustrative Inruuts Hair Root Wellness Box" eyebrow="Your box begins with your profile" title="Five layers. One understandable route." copy="Answer seven focused questions and receive one illustrative system recommendation with visible reasoning and a clear safety boundary." />
  </main>;
}
