...
export const metadata: Metadata = { title: "Women's Hair Loss Guide | Inruuts Design 2", description: "Understand widening parts, shedding, breakage, life-stage factors and realistic hair-care routes." };
...
export default function DesignTwoWomen() {
  return <main className="d2w-page d2w-women">
    ...
    <D2ProblemSplit image="/assets/shedding-breakage.jpg" alt="Comparison of shedding, breakage and follicle growth" eyebrow="The distinction" title="Shedding and breakage leave different clues." intro="The words are often used interchangeably, but the difference changes what questions and care make sense." rows={[
    ...
    <D2Statement quote="Hair needs nutrients. That does not mean everyone needs a supplement." detail="Visible loss does not prove a deficiency. An Inruuts practitioner should avoid guessing and recommend outside licensed care when history and symptoms suggest testing may be useful." />
    <D2EditorialSplit image="/assets/practitioner-conversation.jpg" alt="Hair wellness practitioner reviewing a client's routine journal" eyebrow="When a practitioner pauses the box" title="Sudden patches, pain, burning, scaling, scarring or eyebrow loss." copy="Do not cover these signs with a generic growth bundle. They sit outside the Inruuts wellness profile and should be assessed by an appropriate licensed medical professional." alert />
