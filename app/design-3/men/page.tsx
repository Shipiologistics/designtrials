...
export const metadata: Metadata = { title: "Men's Hair Loss Guide | Inruut Design 3", description: "Understand common male hair-loss patterns, DHT, realistic care options and when to see a dermatologist." };
