  ...
  return (
    <footer className="d3-footer">
      ...
      <div className="d3-footer-map">
        <Link className="d3-footer-brand" href="/design-3">INRUUT</Link>
      ...
      <div className="d3-footer-legal"><p>Educational prototype only. Inruut does not diagnose, treat, cure, or prevent disease. Product formulas, claims, pricing, and clinical pathways require U.S. regulatory and professional review before launch.</p><span>United States / 2026</span></div>
    </footer>
  );
}
