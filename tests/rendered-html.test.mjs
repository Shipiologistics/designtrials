...
test("includes generated editorial assets and the U.S.-only brief", async () => {
  const assets = [
    ...
    "hair-cycle-anagen-v2.jpg", "hair-cycle-catagen-v2.jpg", "hair-cycle-telogen-v2.jpg",
    "science-library-healthy-v2.jpg", "science-library-miniaturization-v2.jpg", "science-library-cycle-v2.jpg",
    "science-library-scalp-v2.jpg", "science-library-nutrition-v2.jpg",
